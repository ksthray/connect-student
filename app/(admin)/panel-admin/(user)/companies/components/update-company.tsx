...
const UpdateCompany = ({
  ...
  const mutation = useMutation({
    mutationFn: (state: DataPost) => {
      return api.put(`/admin/companies/${company.id}`, state, {
        headers: {
  ...
  return (
    <Dialog open={open} onOpenChange={setopen}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle> Mise à jour du compte entreprise </DialogTitle>
          <DialogDescription>
            Mettre à jour le compte entreprise
          </DialogDescription>
        </DialogHeader>
        <div>
          <Form {...form}>
              ...
              <div className="flex text-left flex-col gap-2 ">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Nom complet du gestion de ce compte entreprise
                      </FormLabel>
                      <FormControl>
                        <Input
                          type="text"
